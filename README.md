...
Thank you for considering contributing to this project! The contribution guide can be found in the [contributing documentation](CONTRIBUTING.md).

## Code of Conduct

In order to ensure that the project's community is welcoming to all, please review and abide by the [Code of Conduct](CODE_OF_CONDUCT.md).

## Security Vulnerabilities

If you discover a security vulnerability within the project, please send an e-mail to Juan Manuel Cortéz via [juanm.cortez@gmail.com](mailto:juanm.cortez@gmail.com). All security vulnerabilities will be promptly addressed. You can review the minimun security consideration on the [security documentation](SECURITY.md)
